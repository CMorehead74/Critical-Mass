...
{	 
	...
	if ((m_CMElements[CM_CREDITS_ELEMENTS].GetPosY() + m_CMElements[CM_CREDITS_ELEMENTS].GetRect().GetHeight()) - 3000.0f <= 0.0f)//  * (m_Renderer->GetScreenHeight() / 720.0f))
	{
		m_CMElements[CM_CREDITS_ELEMENTS].SetPosY((float)m_Renderer->GetScreenHeight());
